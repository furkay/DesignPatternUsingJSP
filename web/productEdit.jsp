...
<%  request.setCharacterEncoding("utf-8");
    ...
    if (session.getAttribute("Oturum") == null) {
        ...
        product = Islemler.tblproduct_crd.idyeGoreKayitObjeGetir(id);
        //String ad=katilimci.getKatilimciAdi();
    }
%>  
<!DOCTYPE html>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading"> Ürün Düzelt</div>
                <div class="panel-body">
                    <form method="post" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-md-12" style="margin-top: 30px">
                                <label class="col-md-4 control-label"> Ürün Adı :</label>
                                <div class="col-md-8">
                                    <input type="text" name="txtProductName" class="form-control "  value="<%= product.getProductName()%>"  />
                                </div>
                            ...
                            <div class="col-md-12" style="margin-top: 30px">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="txtProductPrice" class="form-control "  value="<%= product.getProductPrice()%>"  />
                                </div>
                        ...
                        <div class="form-group text-right" style="padding:50px;">

                            <button type="submit" name="btnKaydet"  class="btn btn-success" style="margin-top:20px;width:200px;">Düzelt</button>
                        </div>    
                        ...
                        <%  request.setCharacterEncoding("utf-8");
                            if (request.getParameter("btnKaydet") != null) {
                                ...
                                nesne.setpkProductID(product.getpkProductID());
                                Islemler.tblproduct_crd.Duzelt(nesne);
